...
<%@ page import="edu.njust.tms.dao.StudentSelectCourseInfo" %>
<%@ page import="edu.njust.tms.dao.Student" %>
<%@ page import="edu.njust.tms.dao.CourseInfo" %>
...
%>
<HTML><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><HEAD><TITLE>查看选课信息</TITLE>
<STYLE type=text/css>
